...
class Cart extends Component {
    ...
    renderProductsOfCart() {
        ...
        if (products && products.length > 0) {
            ...
            return <NoProduct information={"Koszyk jest pusty!"}/>
        }
    }
    ...
    renderSummary = () => {
        ...
        if (summaryCost !== 0 && products.length > 0) {
            return (
                <div>
                    <Link to='/'><i className="fas fa-arrow-left"></i>Wróć do sklepu</Link>
                    <div>
                        <p>Całkowity koszt: <span>{this.state.summaryCost}</span></p>
                        <button className="btn-buy-cart">Kup</button>
                    </div>
                </div>
            )
        }
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 text-center">
                        <h1 className="shopping-cart-title">Koszyk:</h1>
                    </div>
                </div>
                <div className="row">
