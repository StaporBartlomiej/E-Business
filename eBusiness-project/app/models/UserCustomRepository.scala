...
import models.ReservationsRepository
...
/**
  ...
  */
@Singleton
class UserCustomRepository @Inject()(dbConfigProvider: DatabaseConfigProvider, reservationsRepository: ReservationsRepository)(implicit ec: ExecutionContext) {
  ...
  import reservationsRepository.ReservationsTable
